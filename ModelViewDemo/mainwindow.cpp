...
//    //新建一个 QTableView 对象
//    //为 QTableView 对象设置相同的 Model
//    QItemSelectionModel *selectionModel=new QItemSelectionModel(model);
//    table->setSelectionModel(selectionModel);
//    connect(selectionModel,SIGNAL(selectionChanged(QiternSelection,
//    IternSelecion)),table,SLOT(selectionChanged(QiternSelection,QiternSelection)));
//    // (bl

...
{
    ui.setupUi(this);
    setWindowTitle("database connect");
...
void ConnDlg::creatDB()
{
    ...
    //(c)
    query.exec(QObject::tr("insert into cars values(1,'奥迪 A6',1,2005)"));
    ...
    query.exec(QObject::tr("insert into cars values(6,'标致 307',2, 2001)"));
...
void ConnDlg::driverChanged(const QString &text)
{
    if(text=="QSQLITE")
    {
        ...
        ui.editUsemame->setEnabled(false);
        ...
        ui.editUsemame->setEnabled(true);
